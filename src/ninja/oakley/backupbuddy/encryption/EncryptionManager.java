...
public class EncryptionManager {
    ...
    public KeyHandler addKey(Path path) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException, KeyAlreadyExistsException {
        RSAPrivateCrtKey key = (RSAPrivateCrtKey) loadPrivateKeyFromFile(path);
    ...
    private RSAPrivateCrtKey loadPrivateKeyFromFile(Path path) throws NoSuchAlgorithmException, IOException, InvalidKeySpecException {
