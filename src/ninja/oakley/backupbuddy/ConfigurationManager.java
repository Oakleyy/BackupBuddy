...
public class ConfigurationManager {
	...
	public void saveProjectProfile(Project project) throws ConfigurationException, IOException {
		getConfig().setProperty("accounts/account[projectId = " + project.getProjectId() + "]/path", project.getFilePath().toString());
		getConfig().setProperty("accounts/account[projectId = " + project.getProjectId() + "]/projectId", project.getProjectId());
		getConfig().save();
